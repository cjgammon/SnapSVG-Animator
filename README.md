...
This is a Plugin for Animate CC (formerly Flash) exporting animated SVG using the Snap.svg javascript library to render content.
...
To read more about building or writing your own Custom Platform Plugins for Animate CC go [here](https://helpx.adobe.com/flash/using/enabling-support-custom-platforms.html).
