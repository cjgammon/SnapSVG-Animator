...
def copy_files_main(options):
	...
	if options.config == 'Debug':
		do_copy(r'C:\FPro\src\fcm\plugins\ThirdParty\xerces-c-3.1.1\Build\Win64\VC10\Release\xerces-c_3_1.dll',r'C:\FPro\src\fcm\plugins\DocTypePublisherPlugin\lib\win\debug\64')

	if options.config == 'Release':
		do_copy(r'C:\FPro\src\fcm\plugins\ThirdParty\xerces-c-3.1.1\Build\Win64\VC10\Release\xerces-c_3_1.dll',r'C:\FPro\src\fcm\plugins\DocTypePublisherPlugin\lib\win\release\64')
